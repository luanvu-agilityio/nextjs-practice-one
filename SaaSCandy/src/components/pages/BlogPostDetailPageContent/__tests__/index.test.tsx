...
// Lightweight mocks for child components so we can assert branches without pulling
// in heavy implementations. These intentionally forward props we need to assert.
