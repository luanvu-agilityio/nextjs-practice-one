...
export const AUTH_MESSAGES = {
  ...
  SIGN_IN: {
    ...
    phonePlaceholder: 'Enter phone (+1234567890) for SMS',
    phoneRequiredTitle: 'Phone Required',
    phoneRequiredDescription: 'Please enter your phone number',
    smsCodeSentTitle: 'Code Sent!',
    smsCodeSentDescription: 'Check your phone for the code',
    smsCodeErrorTitle: 'Error',
    smsCodeErrorDescription: 'Failed to send SMS code',
    invalidCodeTitle: 'Invalid Code',
    invalidCodeDescription: 'Please enter a 6-digit code',
    verificationErrorDescription: 'Invalid verification code',
    verificationFailedTitle: 'Verification Failed',
    verificationFailedDescription: 'Invalid or expired code',
    signInFailedDescription: 'Sign in failed',
    successTitle: 'Success!',
    successDescription: 'Successfully signed in!',
    codeResentTitle: 'Code Resent',
    codeResentEmailDescription: 'A new code has been sent to your email',
    codeResentSMSDescription: 'A new code has been sent to your phone',
    codeResendErrorTitle: 'Error',
    codeResendErrorDescription: 'Failed to resend code',
  },
  SIGN_UP: {
    title: 'Sign Up Page',
