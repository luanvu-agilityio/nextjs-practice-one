...
jest.mock('@/components/ui', () => ({
  __esModule: true,
  // Mock the named exports used by HeroSection. Each returns a simple
  // element so tests can query by text/testid and we avoid rendering the
  // real UI library.
  Button: ({
    children,
    ...props
