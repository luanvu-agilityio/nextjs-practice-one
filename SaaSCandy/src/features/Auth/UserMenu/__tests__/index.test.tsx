...
type _UseSessionReturn = ReturnType<typeof useSession>;
type _MaybeUseSessionReturn = Omit<_UseSessionReturn, 'isRefetching'> & {
  isRefetching?: boolean;
};
const mockUseSession = useSession as unknown as jest.MockedFunction<
  () => _MaybeUseSessionReturn
>;
