...
// Utils
import { ContactFormData, ContactSchema } from '@/utils/validation-effect';
import { getFriendlyMessage } from '@/components/ui/ErrorMessage';
...
const ContactPageContent = () => {
  ...
  const {
    ...
    resolver: effectSchemaResolver(ContactSchema),
    defaultValues: {
      name: '',
      email: '',
      projectName: '',
        ...
        <div className='flex flex-col items-center gap-8 sm:gap-12 lg:gap-16'>
          ...
          <div className='w-full'>
            <Image
              ...
              width={1170}
              height={446}
              sizes='(max-width: 640px) 100vw, (max-width: 1024px) 90vw, 1170px'
              loading='lazy'
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-7.5 items-start lg:items-center'>
          ...
          <div className='w-full order-1 lg:order-2'>
            <Image
              ...
              width={570}
              height={570}
              sizes='(max-width: 1024px) 448px, 570px'
              priority
